...
const Product = () => {
  ...
  const filteredProducts = filterFeatured === 'all' 
    ? product
    ...
    <div>
      <div className="flex justify-between items-center my-3 gap-9 md:gap-0 mx-2 border p-2 rounded-md">
        ...
        <div className="hidden lg:flex justify-between items-center gap-2 w-full lg:w-auto">
          ...
          <button 
            ...
            className={`btn rounded-3xl hover:bg-[#019267] hover:text-white ${filterFeatured === 'all' ? 'bg-[#019267] text-white' : ''}`}
          >
            ALL PRODUCTS
          </button>
          {/* best sellers Button */}
          <button 
            ...
            className={`btn uppercase rounded-3xl hover:bg-[#019267] hover:text-white ${filterFeatured === 'best sellers' ? 'bg-[#019267] text-white' : ''}`}
          >
            Best sellers
          </button>
          {/* Top Rated Button */}
          <button 
            ...
            className={`btn rounded-3xl hover:bg-[#019267] hover:text-white ${filterFeatured === 'topRated' ? 'bg-[#019267] text-white' : ''}`}
          >
            TOP RATED
          </button>
          {/* On Sale Button */}
          <button 
            ...
            className={`btn rounded-3xl hover:bg-[#019267] hover:text-white ${filterFeatured === 'onSale' ? 'bg-[#019267] text-white' : ''}`}
          >
            ON SALE
          </button>
          {/* In Stock Button */}
          <button 
            ...
            className={`btn w-full md:w-auto rounded-3xl hover:bg-[#019267] hover:text-white ${filterFeatured === 'inStock' ? 'bg-[#019267] text-white' : ''}`}
          >
            IN STOCK
          </button>
        </div>
      ...
      {isDropdownOpen && (
        <div className="lg:hidden grid grid-cols-3 md:grid-cols-5 gap-2 my-5">
          <button onClick={() => filterProducts('all')} className="btn rounded-3xl px-4 py-2 hover:bg-gray-100">
            ALL PRODUCTS
          </button>
          <button onClick={() => filterProducts('best sellers')} className="btn rounded-3xl uppercase px-4 py-2 hover:bg-gray-100">
          Best sellers
          </button>
          <button onClick={() => filterProducts('top rated')} className="btn rounded-3xl px-4 py-2 hover:bg-gray-100">
            TOP RATED
          </button>
          <button onClick={() => filterProducts('on sale')} className="btn rounded-3xl px-4 py-2 hover:bg-gray-100">
            ON SALE
          </button>
          <button onClick={() => filterProducts('in stock')} className="btn rounded-3xl px-4 py-2 hover:bg-gray-100">
            IN STOCK
          </button>
        </div>
      )}
