...
const CartModalShowCard = ({ carts }) => {
  ...
  return (
    <div>
      <div className="flex justify-between gap-10 md:gap-0 border border-[#019267] p-2 rounded-lg w-full md:w-80 ">
        ...
        <div className="">
          <button onClick={() => handleDelete(_id)}>
            <RiDeleteBin6Line className="text-xl md:text-2xl font-medium text-[#F0592A]"></RiDeleteBin6Line>
          </button>
        </div>
      </div>
    </div>
